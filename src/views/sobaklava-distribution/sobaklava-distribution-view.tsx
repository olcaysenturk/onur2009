    ...
    <>
      ...
      <main className="bg-[#fbf9f4] pt-16 text-[#1b1c19] md:pt-20">
        <section className="relative flex min-h-[620px] items-center overflow-hidden px-4 py-20 text-white md:min-h-[760px] md:px-10">
          ...
          />
          <div className="relative z-10 mx-auto w-full max-w-[1200px] text-center drop-shadow-[0_3px_16px_rgba(0,0,0,0.75)]">
            <span className="inline-flex items-center gap-2 rounded-full bg-primary/70 px-4 py-2 font-sans text-[11px] font-bold uppercase tracking-[0.12em] text-accent backdrop-blur">
            ...
            <div className="mt-10 flex flex-col justify-center gap-4 sm:flex-row">
              <Link
                href="#products"
                className="inline-flex min-h-12 items-center justify-center rounded-full bg-primary px-8 font-sans text-xs font-bold uppercase tracking-[0.1em] text-white shadow-[0_16px_40px_rgba(78,52,46,0.18)] transition-colors hover:bg-primary-deep"
              >
                {copy.productsCta}
              </Link>
              <Link
          ...
          <div className="mx-auto grid max-w-[1120px] grid-cols-1 items-center gap-12 lg:grid-cols-12 lg:gap-16">
            <div className="relative lg:col-span-6">
              ...
              <div className="absolute -bottom-6 right-6 hidden rounded bg-white px-7 py-6 shadow-[0_18px_45px_rgba(78,52,46,0.12)] md:block">
                <p className="font-display text-3xl font-bold text-accent">70+</p>
            ...
            <div className="lg:col-span-5 lg:col-start-8">
              <p className="font-sans text-[11px] font-bold uppercase tracking-[0.12em] text-accent">
                {copy.aboutLabel}
              </p>
              ...
              <div className="mt-10 grid grid-cols-2 gap-6 border-t border-[#d1c5b4] pt-8">
                <div>
                  <Star aria-hidden className="h-7 w-7 text-accent" />
                  <p className="mt-3 font-sans text-[11px] font-bold uppercase tracking-[0.12em] text-[#1b1c19]">
                    {copy.qualityTitle}
                  </p>
                </div>
                <div>
                  <Utensils aria-hidden className="h-7 w-7 text-accent" />
                  <p className="mt-3 font-sans text-[11px] font-bold uppercase tracking-[0.12em] text-[#1b1c19]">
                    {copy.craftTitle}
                  </p>
                </div>
              ...
              {products.map((product) => (
                <article key={product.title} className="group">
                  <div className="relative aspect-[5/4] overflow-hidden rounded-lg bg-white shadow-[0_18px_40px_rgba(78,52,46,0.08)]">
                    ...
                    />
                    <span className="absolute right-4 top-4 rounded-full bg-accent px-3 py-1 font-sans text-[10px] font-bold uppercase tracking-[0.1em] text-white shadow-[0_10px_24px_rgba(13,159,196,0.22)]">
                      {product.badge}
                    </span>
                  </div>
                  <div className="mt-5 flex items-center gap-3">
                    ...
                    <p className="whitespace-nowrap text-sm font-bold text-accent">{product.price}</p>
                  </div>
            ...
            <div className="lg:col-span-5">
              ...
              <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-2">
                <div className="rounded bg-white px-5 py-4 shadow-[0_14px_30px_rgba(78,52,46,0.08)]">
                  <Coffee aria-hidden className="h-5 w-5 text-accent" />
                ...
                <div className="rounded bg-white px-5 py-4 shadow-[0_14px_30px_rgba(78,52,46,0.08)]">
                  <Store aria-hidden className="h-5 w-5 text-accent" />
          ...
          <div className="mx-auto grid max-w-[1120px] grid-cols-1 items-center gap-12 lg:grid-cols-12 lg:gap-16">
            <div className="rounded-lg bg-white p-6 text-[#1b1c19] shadow-[0_20px_55px_rgba(0,0,0,0.2)] lg:col-span-5">
              <div className="flex items-start justify-between gap-6">
                ...
                <div className="rounded-full bg-[#f0eee9] px-3 py-1 text-xs font-bold text-accent">
                  2022-2025
                </div>
              </div>
                    ...
                    {growthBars.map((bar) => (
                      <div key={bar.year} className="flex h-full flex-1 flex-col items-center justify-end gap-3">
                        <div className="flex h-full w-full max-w-[64px] items-end justify-center gap-2">
                          <span
                            className="w-5 rounded-t bg-accent shadow-[0_8px_18px_rgba(13,159,196,0.18)]"
                            style={{ height: `${bar.supply}%` }}
                            aria-label={`${bar.year} ${copy.growthChartSupply} ${bar.supply}`}
                          />
                          <span
                            className="w-5 rounded-t bg-secondary shadow-[0_8px_18px_rgba(0,103,128,0.16)]"
            ...
            <div className="lg:col-span-6 lg:col-start-7">
              ...
              <div className="mt-10 grid grid-cols-2 gap-8 border-t border-white/10 pt-8">
                <div>
                  <Award aria-hidden className="mb-3 h-6 w-6 text-accent" />
                ...
                <div>
                  <BarChart3 aria-hidden className="mb-3 h-6 w-6 text-accent" />
                  <p className="font-display text-3xl font-bold text-accent">900k+</p>
                  <p className="mt-1 font-sans text-[10px] font-bold uppercase tracking-[0.12em] text-white/70">
                    {copy.guestLabel}
                  </p>
                </div>
        ...
        <section className="px-4 py-20 md:px-10 md:py-28">
          <div className="mx-auto grid max-w-[1080px] grid-cols-1 overflow-hidden rounded-2xl bg-[#eae8e3] shadow-[0_22px_60px_rgba(78,52,46,0.10)] md:grid-cols-2">
            <div className="flex flex-col justify-center p-8 md:p-14">
              <ShieldCheck aria-hidden className="mb-6 h-8 w-8 text-accent" />
              ...
              <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                <Link
                  href="/contact"
                  className="inline-flex min-h-12 items-center justify-center rounded bg-primary px-6 font-sans text-xs font-bold uppercase tracking-[0.1em] text-white transition-colors hover:bg-primary-deep"
                >
                  {copy.stores}
                </Link>
                <Link
                  href="/contact"
                  className="inline-flex min-h-12 items-center justify-center rounded border border-accent px-6 font-sans text-xs font-bold uppercase tracking-[0.1em] text-accent transition-colors hover:bg-white/60"
                >
                  {copy.franchise}
                </Link>
              </div>
      ...
      {activeStoreImage ? (
        ...
        >
          ...
          <button
            aria-label="Close"
            className="absolute right-4 top-4 z-20 flex h-11 w-11 items-center justify-center rounded-full bg-white text-[#1b1c19] transition-colors hover:bg-accent/15 md:right-8 md:top-8"
            onClick={closeLightbox}
            type="button"
          >
